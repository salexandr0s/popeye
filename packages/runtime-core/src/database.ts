...
const APP_MIGRATIONS: Migration[] = [
  ...
  {
    id: '031-app-knowledge-base',
    statements: [
      `CREATE TABLE IF NOT EXISTS knowledge_sources (
        id TEXT PRIMARY KEY,
        workspace_id TEXT NOT NULL REFERENCES workspaces(id),
        knowledge_root_id TEXT NOT NULL REFERENCES file_roots(id),
        ...
        normalized_markdown_path TEXT NOT NULL,
        conversion_warnings_json TEXT NOT NULL DEFAULT '[]',
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL
      );`,
      'CREATE INDEX IF NOT EXISTS idx_knowledge_sources_workspace_created ON knowledge_sources(workspace_id, created_at DESC);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_sources_root_status ON knowledge_sources(knowledge_root_id, status);',
      ...
      'CREATE UNIQUE INDEX IF NOT EXISTS idx_knowledge_documents_workspace_kind_slug ON knowledge_documents(workspace_id, kind, slug);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_documents_workspace_kind_updated ON knowledge_documents(workspace_id, kind, updated_at DESC);',
      ...
      'CREATE INDEX IF NOT EXISTS idx_knowledge_revisions_document_created ON knowledge_document_revisions(document_id, created_at DESC);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_revisions_workspace_status ON knowledge_document_revisions(workspace_id, status);',
      `CREATE TABLE IF NOT EXISTS knowledge_links (
        id TEXT PRIMARY KEY,
        workspace_id TEXT NOT NULL REFERENCES workspaces(id),
        source_document_id TEXT NOT NULL REFERENCES knowledge_documents(id),
        target_document_id TEXT REFERENCES knowledge_documents(id),
        target_slug TEXT,
      ...
      'CREATE INDEX IF NOT EXISTS idx_knowledge_links_source ON knowledge_links(source_document_id, updated_at DESC);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_links_target ON knowledge_links(target_document_id, updated_at DESC);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_links_workspace_status ON knowledge_links(workspace_id, link_status);',
      ...
      'CREATE INDEX IF NOT EXISTS idx_knowledge_compile_jobs_workspace_created ON knowledge_compile_jobs(workspace_id, created_at DESC);',
    ],
  },
  {
    id: '032-app-knowledge-reingest-and-snapshots',
    statements: [
      'ALTER TABLE knowledge_sources ADD COLUMN canonical_source_key TEXT;',
      "ALTER TABLE knowledge_sources ADD COLUMN latest_outcome TEXT NOT NULL DEFAULT 'created';",
      'CREATE UNIQUE INDEX IF NOT EXISTS idx_knowledge_sources_canonical_key ON knowledge_sources(workspace_id, canonical_source_key) WHERE canonical_source_key IS NOT NULL;',
      `CREATE TABLE IF NOT EXISTS knowledge_source_snapshots (
        ...
        original_dir_path TEXT NOT NULL,
        normalized_markdown_path TEXT NOT NULL,
        assets_dir_path TEXT,
        conversion_warnings_json TEXT NOT NULL DEFAULT '[]',
        created_at TEXT NOT NULL
      );`,
      'CREATE INDEX IF NOT EXISTS idx_knowledge_source_snapshots_source_created ON knowledge_source_snapshots(source_id, created_at DESC);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_source_snapshots_workspace_created ON knowledge_source_snapshots(workspace_id, created_at DESC);',
    ],
  },
  {
    id: '033-app-knowledge-search-and-history',
    statements: [
      "ALTER TABLE knowledge_source_snapshots ADD COLUMN outcome TEXT NOT NULL DEFAULT 'updated';",
  ...
  {
    id: '034-app-knowledge-beta-runs',
    statements: [
      `CREATE TABLE IF NOT EXISTS knowledge_beta_runs (
        id TEXT PRIMARY KEY,
        workspace_id TEXT NOT NULL REFERENCES workspaces(id),
        manifest_path TEXT,
        report_markdown TEXT NOT NULL,
        imports_json TEXT NOT NULL,
        reingests_json TEXT NOT NULL DEFAULT '[]',
        converters_json TEXT NOT NULL DEFAULT '[]',
        audit_json TEXT NOT NULL,
        gate_json TEXT NOT NULL,
        import_count INTEGER NOT NULL DEFAULT 0,
        reingest_count INTEGER NOT NULL DEFAULT 0,
        hard_failure_count INTEGER NOT NULL DEFAULT 0,
        import_success_rate REAL NOT NULL DEFAULT 0,
        gate_status TEXT NOT NULL,
        created_at TEXT NOT NULL
      );`,
      'CREATE INDEX IF NOT EXISTS idx_knowledge_beta_runs_workspace_created ON knowledge_beta_runs(workspace_id, created_at DESC);',
      'CREATE INDEX IF NOT EXISTS idx_knowledge_beta_runs_workspace_gate ON knowledge_beta_runs(workspace_id, gate_status, created_at DESC);',
    ],
  },
];
