...
| Email          | `GET /v1/email/accounts`, `GET /v1/email/threads`, `GET /v1/email/threads/:id`, `GET /v1/email/messages/:id`, `GET /v1/email/digest`, `GET /v1/email/drafts`, `GET /v1/email/drafts/:id`, `GET /v1/email/search`, `POST /v1/email/accounts`, `POST /v1/email/sync`, `POST /v1/email/digest`, `GET /v1/email/providers`, `POST /v1/email/drafts`, `PATCH /v1/email/drafts/:id` |
