...
import {
  ...
  KnowledgeSourceSnapshotListResponseApiSchema,
...
const publicSchemas = {
  ...
  KnowledgeSourceResponse: KnowledgeSourceResponseSchema,
  KnowledgeSourceListResponse: KnowledgeSourceListResponseSchema,
  KnowledgeImportResponse: KnowledgeImportResponseSchema,
  KnowledgeDocumentListResponse: KnowledgeDocumentListResponseSchema,
  KnowledgeDocumentDetailResponse: KnowledgeDocumentDetailResponseSchema,
  KnowledgeDocumentRevisionListResponse: KnowledgeDocumentRevisionListResponseSchema,
  KnowledgeDocumentRevisionResponse: KnowledgeDocumentRevisionResponseSchema,
  KnowledgeRevisionApplyResponse: KnowledgeRevisionApplyResponseSchema,
  KnowledgeRevisionRejectResponse: KnowledgeRevisionRejectResponseSchema,
  KnowledgeNeighborhoodResponse: KnowledgeNeighborhoodResponseSchema,
  KnowledgeLinkResponse: KnowledgeLinkResponseSchema,
  KnowledgeSourceSnapshotListResponse: KnowledgeSourceSnapshotListResponseApiSchema,
  KnowledgeCompileJobListResponse: KnowledgeCompileJobListResponseSchema,
  KnowledgeConverterListResponse: KnowledgeConverterListResponseApiSchema,
  KnowledgeAuditResponse: KnowledgeAuditResponseSchema,
  KnowledgeBetaRunListResponse: KnowledgeBetaRunListResponseApiSchema,
  KnowledgeBetaRunResponse: KnowledgeBetaRunResponseSchema,
