...
const COMMANDS: Record<string, Record<string, { desc: string; usage: string; args?: string; examples?: string[] }>> = {
  ...
  todo: {
    connect: { desc: 'Connect Google Tasks via browser OAuth', usage: 'pop todo connect [--google-tasks] [--read-only|--read-write] [--reconnect <connectionId>] [--no-open]' },
    ...
    reprioritize: { desc: 'Reprioritize a local todo', usage: 'pop todo reprioritize <id> <priority>' },
